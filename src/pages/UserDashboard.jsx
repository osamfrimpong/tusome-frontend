...
import { Grid, Paper, Typography, CircularProgress, Avatar, Button, Box,IconButton,Drawer,List,ListItem,ListItemText} from '@mui/material';
...
const UserDashboard = () => {
  ...
  const [profilePicture, setProfilePicture] = useState('https://example.com/profile-picture.jpg');
    ...
    <Button component={Link} to="/login" onClick={handleLogout}>
      ...
      <Grid  spacing={3} sx={{ maxWidth: '90%', justifyContent: 'center' }}>
        <Grid item xs={12} md={8}>
          <Paper elevation={3} sx={{ p: 3, borderRadius: '12px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', bgcolor: 'theme' }}>
            <Typography variant="h4" gutterBottom sx={{ textAlign: 'center' }}>
              Welcome, {username}!
            </Typography>
            <Avatar src={profilePicture} alt="Profile Picture" sx={{ width: 100, height: 100, mx: 'auto', mb: 3 }} />
            <Grid container spacing={3}>
              <Grid item xs={12} sm={6} md={4}>
                <Paper elevation={3} sx={{ p: 2, borderRadius: '12px', bgcolor: 'theme' }}>
